...
exports.UnicodeTrie = (0, utrie_1.createTrieFromBase64)(grapheme_break_trie_1.base64, grapheme_break_trie_1.byteLength);
...
var GraphemeBreaker = function (str) {
    var codePoints = (0, exports.toCodePoints)(str);
    var length = codePoints.length;
    var index = 0;
    var lastEnd = 0;
    var classTypes = codePoints.map(exports.codePointToClass);
...
var splitGraphemes = function (str) {
    var breaker = (0, exports.GraphemeBreaker)(str);
    var graphemes = [];
    var bk;
